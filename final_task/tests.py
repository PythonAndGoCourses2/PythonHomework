...
class LogicTests(unittest.TestCase):
    ...
    def test_calculate(self):
        self.assertEqual(main_funcs.calculate('-+---+-1', methods), str(-+---+-1))
        self.assertEqual(main_funcs.calculate('2---2', methods), str(2---2))
        ...
        self.assertEqual(main_funcs.calculate('5*abs(-2)/round(5.3)', methods), '2.0')
