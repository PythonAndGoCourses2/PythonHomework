...
class ExpectedSuccessTestCase(unittest.TestCase):
    ...
    def test5(self):
        self.assertEqual(False, calc_obj.validate_parsed_list([1.0, '+', 2.0,
                                                                                                         '*', 2.0]))
    ...
    def test14(self):
        self.assertEqual(False, calc_obj.validate_parsed_list(['log10', '(',
                                                                                                         100.0, ')']))

    def test15(self):
        self.assertEqual(False, calc_obj.validate_parsed_list(
    ...
    def test18(self):
        self.assertEqual(False, calc_obj.validate_parsed_list(['round', '(',
                                                                                                         123.456789,
                                                                                                         ')']))
    ...
    def test39(self):
        self.assertEqual(False, calc_obj.validate_parsed_list(['log', '(', 1.0, ',',
                                                                                  '(', '-', 13.0, ')', ')']))
