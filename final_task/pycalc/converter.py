        ...
        while pos < len(iExpr):
            if num.match(iExpr, pos):
                ...
                if len(operatorStack)!=0:
                    ...
                    cond =(func.match(top) or (op.match(top) and  
                        (definitions._operators[top].priority > definitions._operators[match.group()].priority )) 
                        or (op.match(top) and 
                        (definitions._operators[top].priority == definitions._operators[match.group()].priority 
                        and definitions._operators[top].LAssos ))) and top!="(" 
                    if not cond:
