...
class TestConverter(unittest.TestCase):
    ...
    def test_init_class(self):
        converter = Converter([42, '+', 3], function_dict)
    ...
    def test_clean_add_sub_operators_minus_into_plus_after_bracket(self):
        converter = Converter([42], function_dict)
        converter.last_item = '--'
    ...
    def test_converter_append_append_clean_add_operator(self):
        converter = Converter([42, '+', '-', '-', 8], function_dict)
        converter.converter()
    ...
    def test_converter_append_function(self):
        converter = Converter(['sin', '(', 42, ')'], function_dict)
        converter.converter()
