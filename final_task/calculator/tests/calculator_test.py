...
class TestCalculate(unittest.TestCase):
    ...
    def testFunc(self):
        ...
        self.assertEqual(self.calculator.calculate(iExpr), eval("math.sin(math.pi/2)*111*6"))
        iExpr = "2*sin(pi/2)"
        self.assertEqual(self.calculator.calculate(iExpr), eval("2*math.sin(math.pi/2)"))
        iExpr = "2^3^2^2"
    ...
    def testComparison(self):
        ...
        self.assertEqual(self.calculator.calculate(iExpr), eval(iExpr))
        iExpr = r"e^5>=e^5+1"
        self.assertEqual(self.calculator.calculate(iExpr), eval("math.e**5>=math.e**5+1"))
    ...
    def testCommon(self):
        ...
        self.assertEqual(self.calculator.calculate(iExpr), eval("(2.0**(math.pi/math.pi+math.e/math.e+2.0**0.0))"))
        iExpr = r"(2.0^(pi/pi+e/e+2.0^0.0))^(1.0/3.0)"
        self.assertEqual(self.calculator.calculate(iExpr), eval("(2.0**(math.pi/math.pi+math.e/math.e+2.0**0.0))**(1.0/3.0)"))
        #iExpr = r"sin(pi/2^1) + log(1*4+2^2+1, 3^2)"
        #self.assertEqual(self.calculator.calculate(iExpr), eval("math.sin(math.pi/2**1) + math.log(1*4+2**2+1, 3**2)"))
        iExpr = r"10*e^0*log10(.4 -5/ -0.1-10) - -abs(-53/10) + -5"
        self.assertEqual(self.calculator.calculate(iExpr), eval("10*math.e**0*math.log10(.4 -5/ -0.1-10) - -abs(-53/10) + -5")) 
        ...
        self.assertEqual(self.calculator.calculate(iExpr), eval("2.0**(2.0**2.0*2.0**2.0)"))
        #iExpr = r"sin(e^log(e^e^sin(23.0),45.0) + cos(3.0+log10(e^-e)))"
        #self.assertEqual(self.calculator.calculate(iExpr), eval("math.sin(math.e**math.log(math.e**math.e**math.sin(23.0),45.0) + math.cos(3.0+math.log10(math.e**-math.e)))"))
    #def testError(self):
        #iExpr = r"((1+2)"
        #self.assertEqual(self.calculator.calculate(iExpr), eval(iExpr))   
