...
class Parser(object):
    def __init__(self):
        ...
        self.lBracketM = definitions.Identifier(
            type='lb', val=re.compile(r'\('))
        self.rBracketM = definitions.Identifier(
            type='rb', val=re.compile(r'\)'))
        self.comma = definitions.Identifier(
            type='comma', val=re.compile(r'\,'))

        self.matchers = (self.numberM, self.functionM, self.operatorM,
                         self.lBracketM, self.rBracketM, self.comma)
